...
fig, ax = plt.subplots()
ax.plot(test1_data[:,0], test1_data[:,5], 'r', label=test1.version)
ax.plot(test2_data[:,0], test2_data[:,5], 'g', label=test2.version)
ax.plot(test3_data[:,0], test3_data[:,5], 'b', label=test3.version)
ax.plot(test4_data[:,0], test4_data[:,5], 'c', label=test4.version)
ax.plot(test5_data[:,0], test5_data[:,5], 'm', label=test5.version)
ax.plot(test6_data[:,0], test6_data[:,5], 'y', label=test6.version)
ax.plot(test7_data[:,0], test7_data[:,5], 'k', label=test7.version)
ax.plot(test8_data[:,0], test8_data[:,5], 'ro-', label=test8.version)
ax.plot(test9_data[:,0], test9_data[:,5], 'go-', label=test9.version)
ax.plot(test10_data[:,0], test10_data[:,5], 'bo-', label=test10.version)
ax.plot(test11_data[:,0], test11_data[:,5], 'co-', label=test11.version)
ax.plot(test12_data[:,0], test12_data[:,5], 'mo-', label=test12.version)
ax.plot(test13_data[:,0], test13_data[:,5], 'yo-', label=test13.version)
ax.plot(test15_data[:,0], test15_data[:,5], 'ko-', label=test15.version)

ax.set(xlabel='m = n = k', ylabel='GFLOPS/sec.',
       title="L1D CACHE MISS")
ax.grid()
ax.legend()
...
fig.savefig("L1D_CACHE_MISS.png")
plt.show()
