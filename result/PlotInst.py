...
fig, ax = plt.subplots()
ax.plot(test1_data[:,0], test1_data[:,3], 'r', label=test1.version)
ax.plot(test2_data[:,0], test2_data[:,3], 'g', label=test2.version)
ax.plot(test3_data[:,0], test3_data[:,3], 'b', label=test3.version)
ax.plot(test4_data[:,0], test4_data[:,3], 'c', label=test4.version)
ax.plot(test5_data[:,0], test5_data[:,3], 'm', label=test5.version)
ax.plot(test6_data[:,0], test6_data[:,3], 'y', label=test6.version)
ax.plot(test7_data[:,0], test7_data[:,3], 'k', label=test7.version)
ax.plot(test8_data[:,0], test8_data[:,3], 'ro-', label=test8.version)
ax.plot(test9_data[:,0], test9_data[:,3], 'go-', label=test9.version)
ax.plot(test10_data[:,0], test10_data[:,3], 'bo-', label=test10.version)
ax.plot(test11_data[:,0], test11_data[:,3], 'co-', label=test11.version)
ax.plot(test12_data[:,0], test12_data[:,3], 'mo-', label=test12.version)
ax.plot(test13_data[:,0], test13_data[:,3], 'yo-', label=test13.version)
ax.plot(test15_data[:,0], test15_data[:,3], 'ko-', label=test15.version)
...
ax.set_ylim([0, 4500000000])

fig.savefig("Inst_retired.png")
plt.show()
